...
class ImageService(
    ...
    private fun chooseSimilarSize(
        ...
        url += if (th != null) {
            ...
            val i2 = (th - ImageSize.W_1920.width).absoluteValue
            val i3 = (th - ImageSize.W_1440.width).absoluteValue
            val i4 = (th - ImageSize.W_1280.width).absoluteValue
            val i5 = (th - ImageSize.W_960.width).absoluteValue
            val i6 = (th - ImageSize.W_640.width).absoluteValue
            val i7 = (th - ImageSize.W_320.width).absoluteValue
            if (i2 == 0) imageDTO.w1920Path
            else if (i3 == 0) imageDTO.w1440Path
                ...
                i3 < i1 && i3 < i2 && i3 < i4 && i3 < i5 && i3 < i6 && i3 < i7 -> imageDTO.w1440Path
                ...
                i7 < i1 && i7 < i2 && i7 < i3 && i7 < i4 && i7 < i5 && i7 < i6 -> imageDTO.w320Path
